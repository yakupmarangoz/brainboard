...
/*
Wanneer je op de signUpButton drukt check of de captcha juist is anders stop je het daar al en genereer het een nieuwe captcha, 
...
document.getElementById("signUpButton").addEventListener("click", async function () 
{
    ...
    try
    {
        const response = await fetch("http://localhost:8080/authentication/create", 
        {
            method: "POST",
